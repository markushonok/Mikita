...
public static partial class Vector
	{
		public static T Length<T>(this Vector2D<T> vector)
			...
			=> LengthTo(vector.X, vector.Y);
		
		public static T Length<T>(this IVector3D<T> vector)
			where T : INumber<T>, IRootFunctions<T>
			=> LengthTo(vector.X, vector.Y, vector.Z);
		...
		public static IVector3D<T> LimitLengthTo<T>
			(
