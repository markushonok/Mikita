...
/// <summary>
/// Represents an asynchronous operation whose semantic outcome is interpreted
/// by matching it against <typeparamref name="T"/>.
/// </summary>
/// <remarks>
/// Awaiting the operation only waits for its completion. <see cref="Match"/>
/// waits for that same operation and then dispatches its outcome. Calling
...
public interface IMatchTask<in T>: ITask
	{
		...
		/// <summary>
		/// Waits for the operation and dispatches its saved semantic outcome.
		/// </summary>
		/// <remarks>
